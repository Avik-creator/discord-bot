...
DISCORD_PUBLIC_KEY = os.getenv(
    "DISCORD_PUBLIC_KEY",
    "571d40a69ef3e59ae7c8db5b4b3e8c9c09d10aa4933b2428cee14ff16e9db38d",
)
...
def _formation(name, rows, bonuses=None):
    return {"name": name, "positions": _build_positions(rows), "bonuses": bonuses or {}}
...
FORMATIONS = {
    ...
    "343_diamond": {
        ...
        "bonuses": {
            "LCM": {"attack": 2, "defense": 1},
            "RCM": {"attack": 2, "defense": 1},
            "LWB": {"defense": 1},
            "RWB": {"defense": 1},
        },
    },
...
FORMATIONS.update(
    {
        ...
        "41212_narrow": _formation(
            ...
            [
                ...
                {"positions": ["LCM", "RCM"], "y": 6, "x_positions": [4, 6]},
                {"positions": ["CAM"], "y": 5},
                {"positions": ["LST", "RST"], "y": 2, "x_positions": [4, 6]},
            ],
        ),
        "451": _formation(
            "4-5-1",
        ...
        "352": _formation(
            ...
            [
                {"positions": ["LCB", "CB", "RCB"], "y": 8},
                {
                    "positions": ["LWB", "LCM", "CAM", "RCM", "RWB"],
                    "y": 6,
                    "x_positions": [2, 4, 5, 6, 8],
                },
...
# Rarity definitions
LOGO_RARITIES = {"common": 1, "rare": 2, "legendary": 3}
